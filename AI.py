...
def wishMe():
    ...
    if hour>=6 and hour<12:
        ...
        speak("Good Night AKSHAT ! ")

    speak("intelligent robi at your Service. Please tell me how can I help You ")
#wishMe()
def takeCommand():
    ...
    try:
        print("Recognizing...")
        query = r.recognize_google(audio, lang='en')
        print(f"AKSHAT Said:{query}\n")
...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login('akshatsachan123456@gmail.com', 'Aksahtakshat36')
    server.sendmail('akshatsachan123456@gmail.com', to, content)
    server.close()
...
if __name__ == "__main__":
    ...
    while True:
        ...
        elif 'email to Dad' and 'send email' in query:
            try:
                speak("What should I say?")
                content = takeCommand()
                to = "anilkumar.sachan36@gmail.com"    
